					...
					@endif
							<form class="form-horizontal form" role="form" method="POST" action="{{ route('register') }}">
								...
								<div class="form-group">
									<label for="user" class="sr-only">Ingresa un nombre de usuario:</label>
									<input type="text" name="user" id="user" class="form-control" placeholder="Ingrese un nombre de usuario">
								</div>
								<div class="form-group">
									<label for="name" class="sr-only">Ingresa tu nombre:</label>
								...
								<div class="form-group">
									<label for="password_confirmation" class="sr-only">Confirma tu clave:</label>
									<input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Confirma tu clave">
								</div>
								<div class="form-group">
